...
for (let i = 0; i < 25; i++) {
  photos.push(new createTestObject(i,i,descriptions[getRandom(0,descriptions.length)],getRandom(15,200),new createTestComments(getRandom(1,135),getRandom(1,6),messages[getRandom(0,messages.length)],nicknames[getRandom(0,nicknames.length)])));
}
